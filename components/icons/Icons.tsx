...
export const CloseIcon = ({ size = 24 }: { size?: number }) => (
    <svg className="h-6 w-6" style={{ height: size, width: size }} stroke="currentColor" fill="none" viewBox="0 0 24 24">
...
export const ArrowRightIcon = () => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path></svg>
);
